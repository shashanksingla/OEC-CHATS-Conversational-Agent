...
If `{story_key}` is not empty and `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final\_bmad\render\bmad-build\child-care-agent-final-e24103dd09db\d9631d991878a1108e2b\sync-sprint-status.md` with `{target_status}` = `in-progress`.
...
If a layer needs subagents and you cannot launch them, write the full prompt for each layer under `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final/_bmad-output/implementation-artifacts` (with placeholders filled in, not just file paths). Stop and ask the user to run each prompt in a separate session and paste back the findings.
...
If `{story_key}` is not empty and `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final\_bmad\render\bmad-build\child-care-agent-final-e24103dd09db\d9631d991878a1108e2b\sync-sprint-status.md` with `{target_status}` = `review`.
