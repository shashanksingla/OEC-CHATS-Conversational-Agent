...
Read `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final\_bmad\render\bmad-build\child-care-agent-final-e24103dd09db\d9631d991878a1108e2b/review-prompts/edge-case-hunter.md` completely and follow it as your review instructions.
...
4. Process entries in cascading order. If intent_gap or bad_spec entries exist, they trigger a loopback — lower entries are moot since code will be re-derived. If neither exists, process patch and defer normally. Before each loopback, read `{spec_file}` frontmatter `review_loop_iteration` (missing means `0`), increment it by 1, and write it back. If it exceeds 5, HALT and escalate to the human.
   ...
   - **defer** — Append one new entry to `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final/_bmad-output/implementation-artifacts/deferred-work.md` using this format. Do not modify existing entries or look for duplicates.
     ```markdown
...
Read fully and follow `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent Final\_bmad\render\bmad-build\child-care-agent-final-e24103dd09db\d9631d991878a1108e2b\step-05-present.md`
