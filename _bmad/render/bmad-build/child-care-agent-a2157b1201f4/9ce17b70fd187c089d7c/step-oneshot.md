...
- Speak in `English`. Write files in `English`.
...
If `{story_key}` is not empty and `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent\_bmad\render\bmad-build\child-care-agent-a2157b1201f4\9ce17b70fd187c089d7c\sync-sprint-status.md` with `{target_status}` = `in-progress`.
...
If a layer needs subagents and you cannot launch them, write the full prompt for each layer under `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent/_bmad-output/implementation-artifacts` (with placeholders filled in, not just file paths). Stop and ask the user to run each prompt in a separate session and paste back the findings.
...
If `{story_key}` is not empty and `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\shsingla\Downloads\Child Care Agent\Child Care Agent\_bmad\render\bmad-build\child-care-agent-a2157b1201f4\9ce17b70fd187c089d7c\sync-sprint-status.md` with `{target_status}` = `review`.
