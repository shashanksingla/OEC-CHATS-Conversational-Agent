({
    doInit : function(component, event, helper) {
        console.log('In-------')
        var action = component.get('c.getIneligibleReason');
        ...
        action.setCallback(this, function(response) {
            if (response.getState() === "SUCCESS") {
                ...
                if(res.objectData){
                    component.set("v.ineligReasonsToBeDisplayed",res.objectData.IndivEligFailureReasonLst);
                    console.log('reasons--'+JSON.stringify(res.objectData));
