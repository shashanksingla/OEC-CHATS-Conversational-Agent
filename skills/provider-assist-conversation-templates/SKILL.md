---
name: provider-assist-conversation-templates
description: Specialized Provider Assist skill for authenticated-provider conversation templates, required response shapes, next actions, failure handling, and provider-facing do/don't rules.
---

# Provider Assist Conversation Templates
